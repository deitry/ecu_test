...
int EC_Engine::sendCanMsg(PAR_ID_BYTES id)
{
	...
	case EC_G_N:
		...
		case EC_S_NRESTR: data.f.val.i = nR._restricted; break;
		}
		break;
	case EC_G_QC:
		switch (id.S)
	...
	case EC_P_M_SENS:
		...
		case EC_S_D_PINJRESTR: data.f.val.i = EG::Pinj._restricted; break;
		}
		break;
	case EC_P_KP:
		data.f.val.f = EG::kP;
...
void EC_Engine::recieveCanMsg(tCANMsgObject* msg)
{
	...
	case EC_G_N:
		...
		case EC_S_NRESTR: nR._restricted = can_data.f.val.i; break;
		}
		break;
	case EC_G_QC:
		switch (msg->pucMsgData[1])
	...
	case EC_P_M_SENS:
		...
		case EC_S_D_PINJRESTR: EG::Pinj._restricted = can_data.f.val.i; break;
		}
		break;
	case EC_P_KP:
